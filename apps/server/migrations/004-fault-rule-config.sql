...
('OVER_TEMPERATURE','超温保护','safety',1,1,1,1,NOW()),
('OVER_PRESSURE','超压保护','safety',1,1,1,1,NOW()),
('LOW_FLOW','持续低流量','safety',1,1,1,1,NOW()),
('COMMAND_PUBLISH_FAILED','控制指令发布失败','safety',1,1,1,1,NOW()),
('SENSOR_FLOW_TIMEOUT','流量传感器超时','safety',1,1,1,1,NOW()),
('SENSOR_PRESSURE_TIMEOUT','压力传感器超时','safety',1,1,1,1,NOW()),
('SENSOR_TEMPERATURE_TIMEOUT','温度传感器超时','safety',1,1,1,1,NOW()),
('CONTROL_CONFIG_INVALID','控制配置无效','safety',1,1,1,1,NOW()),
('BUILD_FLOW_TIMEOUT','建流超时','safety',1,1,1,1,NOW()),
('PUMP_IDLING','水泵空转','safety',1,1,1,1,NOW()),
('TEMP_SENSOR_REVERSED','温度探头装反','safety',1,1,1,1,NOW()),
('DRY_HEATING_NO_TEMP_RISE','加热无温升','safety',1,1,1,1,NOW()),
